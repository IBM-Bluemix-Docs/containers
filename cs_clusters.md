...
Free and standard clusters that are created with a Pay-As-You-Go account must be removed manually when they are not needed anymore so that the cluster is no longer consuming resources.
{:shortdesc}
