...
The main challenge when you create highly available stateful apps is to come up with a way to keep your data in synch across multiple instances. You want to make sure that you have one master that holds the data of your app. All instances in your cluster read from and write to this master database. 
