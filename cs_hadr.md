...
For apps that do not require data replication across data centers or regions, you can persist data on NFS file shares by using Kubernetes persistent volumes. NFS file shares are encrypted at REST and can be replicated to another datacenter. NFS file shares cannot be used to keep data in sync across datacenters or regions. 
