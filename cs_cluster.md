...
8. From the {{site.data.keyword.Bluemix_notm}} Dashboard, navigate to the `Worker Nodes` section of your cluster, select the worker node that you drained, and click `Update Worker`. Or you can run the CLI command. To get your worker node id, run `bx workers <cluster_name_or_id>`.
