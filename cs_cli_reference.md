...
Remove one or more worker nodes from a cluster. If you remove a worker node, your cluster will be unbalanced. You can automatically rebalance your worker pool by running the [bx cs cluster-rebalance](#cs_rebalance) command.
