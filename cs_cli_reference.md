...
### bx cs cluster-update [-f] CLUSTER [--kube-version KUBERNETES VERSION] [--force-update]
{: #cs_cluster_update}
...
<strong>Command options</strong>:
   ...
   <dt><code>--kube-version <em>KUBERNETES VERSION</em></code></dt>
...
### bx cs worker-update [-f] CLUSTER WORKER [WORKER] [--kube-version KUBERNETES VERSION] [--force-update]
{: #cs_worker_update}
