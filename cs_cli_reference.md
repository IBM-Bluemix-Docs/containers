...
<table summary="Commands for creating clusters on {{site.data.keyword.Bluemix_notm}}">
 ...
 <tr>
    ...
    <td>[bx cs logging-config-get](cs_cli_reference.html#logging_get)</td>
    <td>[bx cs logging-config-rm](cs_cli_reference.html#logging_rm)</td>
    <td>[bx cs logging-config-update](cs_cli_reference.html#logging_update)</td>
 </tr>
 <tr>
