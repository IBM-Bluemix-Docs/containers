...
spec:
 ...
 <table>
  ...
  <td>Replace <code>&lt;<em>location_modifier</em>&gt;</code> with the location modifier you want to use for the path. Supported modifiers are '=', '~', '~&#42', and '^~'. You must surround the modifiers in single quotes.</td>
  </tr>
  <tr>
