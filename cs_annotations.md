...
|General annotations|Description|
|--------------------|-----------|
...
|Connection annotations|Description|
|--------------------|-----------|
...
|Proxy buffer annotations|Description|
|--------------------|-----------|
...
|Request and response annotations|Description|
|--------------------|-----------|
...
|[Client response header removal](#response-remove-headers)|Remove header information from a client response before forwarding the response to the client.||[Custom HTTP and HTTPS ports](#custom-port)|Change the default ports for HTTP and HTTPS network traffic.|
...
|Service limit annotations|Description|
|--------------------|-----------|
...
|TLS/SSL authentication annotations|Description|
|--------------------|-----------|
