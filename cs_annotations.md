...
<col width="25%">
 ...
 <tbody>
 <tr>
 <td><strong>Supported annotation</strong></td>
 ...
 <col width="25%">
  <thead>
  <th colspan=2>Connection annotations</th>
  </thead>
  <tbody>
  <tr>
...
<col width="25%">
 <thead>
 <th colspan=2>Proxy buffer annotations</th>
 </thead>
 <tbody>
 <tr>
...
<col width="25%">
<thead>
<th colspan=2>Request and response annotations</th>
</thead>
<tbody>
<tr>
...
<col width="25%">
<thead>
<th colspan=2>Service limit annotations</th>
</thead>
<tbody>
<tr>
...
<col width="25%">
<thead>
<th colspan=2>HTTPS and TLS/SSL authentication annotations</th>
</thead>
<tbody>
<tr>
...
<table>
 ...
 <td>The number of seconds to wait to connect to the back-end app, for example <strong>65s</strong>. <strong>Note:</strong> A connect-timeout cannot exceed 75 seconds.</td>
 </tr>
 <tr>
 <td><code>&lt;read_timeout&gt;</code></td>
 <td>The number of seconds to wait before the back-end app is read, for example <strong>65s</strong>.</td>
 </tr>
 </tbody></table>
...
Change the maximum number of idle keepalive connections to the upstream server of a given service. The upstream server has 64 idle keepalive connections by default.
 ...
 <table>
  ...
  <td>Replace <code>&lt;<em>max_connections</em>&gt;</code> with the maximum number of idle keepalive connections to the upstream server. The default is 64. A zero value disables upstream keepalive connections for the given service.</td>
  </tr>
  </tbody></table>
  </dd>
  </dl>
...
<table>
 ...
 <tr>
 <td><code>&lt;size&gt;</code></td>
 <td>The maximum size of the client response body. For example, to set it to 200 megabyte, define <strong>200m</strong>.  <strong>Note:</strong> You can set the size to 0 to disable the check of the client request body size.</td>
 </tr>
 </tbody></table>
