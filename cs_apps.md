...
2.  Create a load balancer service for the app that you want to expose. To make your app available on the public internet or on a private network, you must create a Kubernetes service for your app and configure your service to include all the pods that make up your app into the load balancing.
    ...
    2.  Define a load balancer service for the app that you want to expose.
        ...
        LoadBalancer service using a default IP address:
        ...
        LoadBalancer service using an annotation to specify a private or public IP address:
