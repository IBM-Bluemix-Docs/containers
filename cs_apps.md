...
<dd>
 <ul>
  ...
  <li>The iptables program in the worker node operating system load balances requests across the app's pods.</li>
  ...
  <li>Use the NodePort service for testing the public access for your app or when public access is needed for a short amount of time only.</li>
 </ul>
</dd>
<dt><a href="#cs_apps_public_load_balancer" target="_blank">LoadBalancer service</a> (standard clusters only)</dt>
<dd>
 <ul>
  ...
  <li>The iptables program in the worker node operating systen load balances requests across the app's pods.</li>
