...
1.  Generate a new IAM access token by using the refresh token or the {{site.data.keyword.Bluemix_notm}} API key.
    ...
    <li>uaa_client_id: cf</li>
    <li>uaa_client_secret:</li>
    <li>bss_account: <em>&lt;account_id&gt;</em></li></ul><p><strong>Note</strong>: Add the <code>uaa_client_secret</code> key with no value specified.</p></td>
    </tr>
    <tr>
    ...
    <li>uaa_client_id: cf</li>
        <li>uaa_client_secret:</li></ul><strong><b>Note</strong>: Add the <code>uaa_client_secret</code> key with no value specified.</p></td>
    </tr>
    </tbody>
    </table>
