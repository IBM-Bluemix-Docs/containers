...
4. The request is forwarded to the private IP address of the pod where the app is deployed. If you have multiple app instances deployed in the cluster, the NodePort service routes the requests between the app pods.
