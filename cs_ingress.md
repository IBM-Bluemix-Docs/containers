...
<img src="images/cs_ingress_planning.png" width="500" alt="Expose an app in {{site.data.keyword.containershort_notm}} by using Ingress" style="width:500px; border-style: none"/>
