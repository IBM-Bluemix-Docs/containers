...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>In order to detect vulnerabilities in running containers, you can install the [container live scanner](/docs/services/va/va_index.html#va_install_livescan).  </td>
    </tr>
  </tbody>
  </table>
