...
2.  The owner of your {{site.data.keyword.Bluemix_dedicated_notm}} account can invite single or multiple users to your Public account.
    ...
    2.  Invite the users to the public account.
        * To invite a single user:
            ...
            Replace <em>&lt;user_IBMid&gt;</em> with the email of the user you want to invite, <em>&lt;public_api_key&gt;</em> with the API key generated in the previous step, and <em>&lt;public_org_id&gt;</em> with the ID of the public account organization.
        ...
        * To invite all users currently in a Dedicated account organization:
            ...
            Replace <em>&lt;dedicated_org_id&gt;</em> with the Dedicated account organization ID, <em>&lt;public_api_key&gt;</em> with the API key generated in the previous step, and <em>&lt;public_org_id&gt;</em> with the public account organization ID.

    3.  An invitation is sent to the users' email addresses. Once the user accepts the invitation, an IBMid is created for the user if one did not already exist. The user is also added to the specified organization in the public account.
    ...
    4.  Verify that the users were added to the account.
        ...
        New users will have a status of either `PENDING` or `ACTIVE` depending on whether or not they have accepted the invitation to the account yet.
...
4.  If your local system or your corporate network controls public internet endpoints by using proxies or firewalls, see [Opening required ports and IP addresses in your firewall](cs_security.html#opening_ports).
