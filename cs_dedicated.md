...
3.  Once users are added to your Public account, you must grant the Administrator role to any user that needs to create a cluster. See [Managing user access](cs_users.html#managing) for information about how to grant the Administrator role.
