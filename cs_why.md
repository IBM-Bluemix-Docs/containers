...
- [Leveraging the capabilities of the service and Kubernetes to ensure high availability of apps](cs_app_planning.html#highly_available_apps)
...
- [Adding or removing additional subnets in IBM Cloud infrastructure (SoftLayer) as needed](cs_subnets.html#subnets)
