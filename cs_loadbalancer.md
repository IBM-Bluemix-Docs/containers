...
When source IP is enabled for a load balancer service, you can ensure that app pods and load balancer service pods deploy to the same worker nodes by adding node affinity and tolerations to app pods.
{: shortdesc}
