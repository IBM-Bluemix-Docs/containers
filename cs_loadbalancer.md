...
**Note:** Load balancer services do not support TLS termination. If your app requires TLS termination, you can expose your app by using [Ingress](cs_ingress.html#config), or configure your app to manage the TLS termination.
