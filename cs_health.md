...
1. Create a log forwarding configuration.
    * To forward logs to {{site.data.keyword.loganalysisshort_notm}}:
      ...
      {: pre}
      ```
      $ cs logging-config-create zac2 --logsource application --app-paths '/var/log/apps.log'
      ...
      7e766053-b347-4c53-8bc4-1a32eb2726bf   application   -           ingest.logging.stage1.ng.bluemix.net✣   9091✣   -     -       ibm        *                        /var/log/apps.log
      ```
      {: screen}
